...
void StilsonMoogFilter::processBlock(const AudioSourceChannelInfo& bufferToFill, int passMode)
{
	int i, pole;
	...
	for (i = 0; i < numSamples; i++) {
		input = buffer->getSample(0, startSample + i);
		...
		buffer->setSample(0, startSample + i, result);
